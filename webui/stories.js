    ...
    var qrcode2 = function() {
        ...
        _this.createDataURL = function(cellSize, margin) {
          ...
          return createDataURL(size, size, function(x2, y2) {
            if (min <= x2 && x2 < max && min <= y2 && y2 < max) {
              var c3 = Math.floor((x2 - min) / cellSize);
              var r3 = Math.floor((y2 - min) / cellSize);
        ...
        var _createHalfASCII = function(margin) {
          ...
          for (y2 = 0; y2 < size; y2 += 2) {
            ...
            for (x2 = 0; x2 < size; x2 += 1) {
              ...
              ascii += margin < 1 && y2 + 1 >= max ? blocksLastLineNoMargin[p4] : blocks[p4];
            }
            ascii += "\n";
          }
          if (size % 2 && margin > 0) {
        ...
        return function(s2) {
          ...
          for (var i3 = 0; i3 < s2.length; i3 += 1) {
            ...
            if (c3 < 128) {
              ...
              var b3 = unicodeMap[s2.charAt(i3)];
              if (typeof b3 == "number") {
                if ((b3 & 255) == b3) {
                  bytes.push(b3);
                } else {
      ...
      var qrAlphaNum = function(data) {
        ...
        _this.write = function(buffer) {
          ...
          while (i3 + 1 < s2.length) {
            buffer.put(
              getCode(s2.charAt(i3)) * 45 + getCode(s2.charAt(i3 + 1)),
              11
            );
            i3 += 2;
          }
      ...
      var base64EncodeOutputStream = function() {
        ...
        var writeEncoded = function(b3) {
          _base64 += String.fromCharCode(encode2(b3 & 63));
        };
      ...
      var base64DecodeInputStream = function(str) {
        ...
        _this.read = function() {
          while (_buflen < 8) {
            ...
            _buffer = _buffer << 6 | decode2(c3.charCodeAt(0));
            _buflen += 6;
          }
      ...
      __rest2 = function(s2, e3) {
        ...
        if (s2 != null && typeof Object.getOwnPropertySymbols === "function")
          for (var i3 = 0, p4 = Object.getOwnPropertySymbols(s2); i3 < p4.length; i3++) {
            if (e3.indexOf(p4[i3]) < 0 && Object.prototype.propertyIsEnumerable.call(s2, p4[i3]))
              t3[p4[i3]] = s2[p4[i3]];
          }
        return t3;
      };
  ...
  "../../node_modules/.pnpm/big-integer@1.6.51/node_modules/big-integer/BigInteger.js"(exports, module) {
    var bigInt = function(undefined2) {
      ...
      function multiplyKaratsuba(x2, y2) {
        ...
        n2 = Math.ceil(n2 / 2);
        var b3 = x2.slice(n2), a3 = x2.slice(0, n2), d3 = y2.slice(n2), c3 = y2.slice(0, n2);
      ...
      function divMod1(a3, b3) {
        var a_l = a3.length, b_l = b3.length, base2 = BASE, result = createArray(b3.length), divisorMostSignificantDigit = b3[b_l - 1], lambda = Math.ceil(base2 / (2 * divisorMostSignificantDigit)), remainder = multiplySmall(a3, lambda), divisor = multiplySmall(b3, lambda), quotientDigit, shift, carry, borrow, i4, l3, q2;
        ...
        for (shift = a_l - b_l; shift >= 0; shift--) {
          ...
          for (i4 = 0; i4 < l3; i4++) {
            ...
            borrow += remainder[shift + i4] - (carry - q2 * base2);
            carry = q2;
            if (borrow < 0) {
      ...
      function divModSmall(value, lambda) {
        var length = value.length, quotient = createArray(length), base2 = BASE, i4, q2, remainder, divisor;
        remainder = 0;
      ...
      BigInteger.prototype.pow = function(v3) {
        var n2 = parseValue(v3), a3 = this.value, b3 = n2.value, value, x2, y2;
        if (b3 === 0)
          return Integer[1];
        if (a3 === 0)
          return Integer[0];
      ...
      function millerRabinTest(n2, a3) {
        var nPrev = n2.prev(), b3 = nPrev, r3 = 0, d3, t3, i4, x2;
        while (b3.isEven())
          b3 = b3.divide(2), r3++;
        next:
      ...
      BigInteger.prototype.modInv = function(n2) {
        var t3 = bigInt.zero, newT = bigInt.one, r3 = parseValue(n2), newR = this.abs(), q2, lastT, lastR;
        while (!newR.isZero()) {
          q2 = r3.divide(newR);
          lastT = t3;
          lastR = r3;
      ...
      function roughLOB(n2) {
        var v3 = n2.value, x2 = typeof v3 === "number" ? v3 | LOBMASK_I : typeof v3 === "bigint" ? v3 | BigInt(LOBMASK_I) : v3[0] + v3[1] * BASE | LOBMASK_BI;
        return x2 & -x2;
      }
...
var index_stories_exports = {};
__export(index_stories_exports, {
  qr: () => QrCodeSection_stories_exports
});

// src/pages/QrCodeSection.stories.tsx
var QrCodeSection_stories_exports = {};
__export(QrCodeSection_stories_exports, {
  SimpleExample: () => SimpleExample,
  default: () => QrCodeSection_stories_default
});
...
function j(n2, u3, i3, t3, o3, r3, f3, e3, c3) {
  var a3, h3, v3, y2, _3, k3, b3, g3, m3, x2, A3, C2, $2, H2, I3, T2 = u3.type;
  ...
  try {
    n:
      if ("function" == typeof T2) {
        if (g3 = u3.props, m3 = (a3 = T2.contextType) && t3[a3.__c], x2 = a3 ? m3 ? m3.props.value : a3.__ : t3, i3.__c ? b3 = (h3 = u3.__c = i3.__c).__ = h3.__E : ("prototype" in T2 && T2.prototype.render ? u3.__c = h3 = new T2(g3, x2) : (u3.__c = h3 = new d(g3, x2), h3.constructor = T2, h3.render = O), m3 && m3.sub(h3), h3.props = g3, h3.state || (h3.state = {}), h3.context = x2, h3.__n = t3, v3 = h3.__d = true, h3.__h = [], h3._sb = []), null == h3.__s && (h3.__s = h3.state), null != T2.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = s({}, h3.__s)), s(h3.__s, T2.getDerivedStateFromProps(g3, h3.__s))), y2 = h3.props, _3 = h3.state, v3)
          ...
          if (null == T2.getDerivedStateFromProps && g3 !== y2 && null != h3.componentWillReceiveProps && h3.componentWillReceiveProps(g3, x2), !h3.__e && null != h3.shouldComponentUpdate && false === h3.shouldComponentUpdate(g3, h3.__s, x2) || u3.__v === i3.__v) {
        ...
        if (h3.context = x2, h3.props = g3, h3.__v = u3, h3.__P = n2, C2 = l.__r, $2 = 0, "prototype" in T2 && T2.prototype.render) {
...
function L(l3, u3, i3, t3, o3, r3, e3, c3) {
  var s2, h3, v3, y2 = i3.props, p4 = u3.props, d3 = u3.type, k3 = 0;
  ...
  if (null === d3)
    y2 === p4 || c3 && l3.data === p4 || (l3.data = p4);
  else {
    if (r3 = r3 && n.call(l3.childNodes), h3 = (y2 = i3.props || f).dangerouslySetInnerHTML, v3 = p4.dangerouslySetInnerHTML, !c3) {
      if (null != r3)
    ...
    if (C(l3, p4, y2, o3, c3), v3)
      ...
      for (k3 = r3.length; k3--; )
        null != r3[k3] && a(r3[k3]);
    c3 || ("value" in p4 && void 0 !== (k3 = p4.value) && (k3 !== l3.value || "progress" === d3 && !k3 || "option" === d3 && k3 !== y2.value) && H(l3, "value", k3, y2.value, false), "checked" in p4 && void 0 !== (k3 = p4.checked) && k3 !== l3.checked && H(l3, "checked", k3, y2.checked, false));
  }
  return l3;
}
function M(n2, u3, i3) {
...
var randombytes = function(x2, n2) {
...
function crypto_hash(out, m3, n2) {
  ...
  x2[n2 - 9] = 0;
  ts64(x2, n2 - 8, b3 / 536870912 | 0, b3 << 3);
...
var HashState = class {
  ...
  finish() {
    ...
    x2[n2 - 9] = 0;
    ts64(x2, n2 - 8, b3 / 536870912 | 0, b3 << 3);
    crypto_hashblocks_hl(this.hh, this.hl, x2, n2);
    for (let i3 = 0; i3 < 8; i3++)
...
function add(p4, q2) {
  const a3 = gf(), b3 = gf(), c3 = gf(), d3 = gf(), e3 = gf(), f3 = gf(), g3 = gf(), h3 = gf(), t3 = gf();
  Z(a3, p4[1], p4[0]);
  Z(t3, q2[1], q2[0]);
  M2(a3, a3, t3);
  A2(b3, p4[0], p4[1]);
...
function cswap(p4, q2, b3) {
  let i3;
  for (i3 = 0; i3 < 4; i3++) {
    sel25519(p4[i3], q2[i3], b3);
  }
}
function pack(r3, p4) {
...
function modL(r3, x2) {
  ...
  for (i3 = 63; i3 >= 32; --i3) {
    ...
    for (j3 = i3 - 32, k3 = i3 - 12; j3 < k3; ++j3) {
      x2[j3] += carry - 16 * x2[i3] * L2[j3 - (i3 - 32)];
...
function crypto_scalarmult_ed25519_base_noclamp(s2) {
...
function crypto_scalarmult_ed25519_noclamp(s2, q2) {
  const r3 = new Uint8Array(32);
  const p4 = [gf(), gf(), gf(), gf()];
...
function crypto_sign_open(m3, sm, n2, pk) {
  ...
  const p4 = [gf(), gf(), gf(), gf()], q2 = [gf(), gf(), gf(), gf()];
  mlen = -1;
  if (n2 < 64)
    return -1;
  if (unpackneg(q2, pk))
...
function crypto_core_ed25519_scalar_reduce(x2) {
  const len = x2.length;
  const z3 = new Float64Array(64);
...
function crypto_core_ed25519_scalar_sub(x2, y2) {
  const z3 = new Float64Array(64);
...
function codecForNumber() {
  return {
    decode(x2, c3) {
      ...
      throw new DecodingError(`expected number at ${renderContext(c3)} but got ${typeof x2}`);
    }
  };
}
function codecForString() {
  return {
    decode(x2, c3) {
      ...
      throw new DecodingError(`expected string at ${renderContext(c3)} but got ${typeof x2}`);
    }
  };
}
...
var URLStateMachine = class {
  ...
  parseScheme(c3, cStr) {
    if (isASCIIAlphanumeric(c3) || c3 === p3("+") || c3 === p3("-") || c3 === p3(".")) {
      this.buffer += cStr.toLowerCase();
    } else if (c3 === p3(":")) {
  ...
  parsePath(c3) {
    if (isNaN(c3) || c3 === p3("/") || isSpecial(this.url) && c3 === p3("\\") || !this.stateOverride && (c3 === p3("?") || c3 === p3("#"))) {
      ...
      if (c3 === p3("%") && (!isASCIIHex(this.input[this.pointer + 1]) || !isASCIIHex(this.input[this.pointer + 2]))) {
        this.parseError = true;
      }
...
function canonicalJson(obj) {
  ...
  for (let i3 = 0; i3 < keys.length; i3++) {
    const key = keys[i3];
    s2 += JSON.stringify(key) + ":" + canonicalJson(obj[key]);
    if (i3 !== keys.length - 1) {
      s2 += ",";
    }
  }
...
function hashBlocks(w3, v3, p4, pos, len) {
  let a3, b3, c3, d3, e3, f3, g3, h3, u3, i3, j3, t1, t22;
  while (len >= 64) {
    a3 = v3[0];
    b3 = v3[1];
    c3 = v3[2];
    ...
    for (i3 = 16; i3 < 64; i3++) {
      ...
      w3[i3] = (t1 + w3[i3 - 7] | 0) + (t22 + w3[i3 - 16] | 0);
    }
    for (i3 = 0; i3 < 64; i3++) {
      t1 = (((e3 >>> 6 | e3 << 32 - 6) ^ (e3 >>> 11 | e3 << 32 - 11) ^ (e3 >>> 25 | e3 << 32 - 25)) + (e3 & f3 ^ ~e3 & g3) | 0) + (h3 + (K2[i3] + w3[i3] | 0) | 0) | 0;
...
function kdf(outputLength, ikm, salt, info) {
  ...
  const N2 = Math.ceil(outputLength / 32);
  const output = new Uint8Array(N2 * 32);
  for (let i3 = 0; i3 < N2; i3++) {
    let buf;
    if (i3 == 0) {
...
(function(DenominationPubKey2) {
  function cmp(p1, p22) {
    ...
    if (p1.cipher < p22.cipher) {
      ...
      if (((_a = p1.age_mask) !== null && _a !== void 0 ? _a : 0) < ((_b = p22.age_mask) !== null && _b !== void 0 ? _b : 0)) {
        return -1;
...
function bigintToNaclArr(x2, size) {
  const byteArr = new Uint8Array(size);
  const arr = x2.toArray(256).value.reverse();
  byteArr.set(arr, 0);
  return byteArr;
}
...
(function(Edx255192) {
  ...
  const L3 = import_big_integer.default.fromArray(revL.reverse(), 256, false);
  ...
  function privateKeyDerive(priv, seed) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const factorModL = bigintFromNaclArr(factorEnc).mod(L3);
      const aPrime = a3.divide(8).multiply(factorModL).mod(L3).multiply(8).mod(L3);
  ...
  function restrictionCommit(ageMask, age) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return {
        commitment: {
          mask: ageMask,
          publicKeys: pubs.map((x2) => encodeCrock(x2))
        },
        proof: {
          privateKeys: privs.map((x2) => encodeCrock(x2))
        }
      };
    });
  }
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return {
        commitment: {
          ...
          publicKeys: newPubs.map((x2) => encodeCrock(x2))
        },
        proof: {
          privateKeys: newPrivs.map((x2) => encodeCrock(x2))
        }
      };
    });
  }
...
function singular(stringSeq, ...values) {
  const s2 = toI18nString(stringSeq);
  const tr = jed.translate(s2).ifPlural(1, s2).fetch(...values);
  return tr;
}
...
function replacePlaceholderWithValues(translation, childArray) {
  ...
  for (let i3 = 0; i3 < childArray.length; i3++) {
    const x2 = childArray[i3];
    if (x2 === void 0) {
      continue;
    } else if (typeof x2 === "string") {
      continue;
    } else {
      placeholderChildren.push(x2);
    }
  }
  const result = [];
...
function stringifyArray(children) {
  ...
  const s2 = ss.join("").replace(/ +/g, " ").trim();
  return s2;
}
var i18n = {
  str: singular,
...
var CancellationToken = class {
  ...
  onCancelled(cb) {
    ...
    return () => {
      var _a2;
      return (_a2 = this._callbacks) === null || _a2 === void 0 ? void 0 : _a2.delete(cb);
    };
  }
  static create() {
...
(function(ContractTermsUtil2) {
  function forgetAllImpl(anyJson, path, pred) {
    ...
    if (Array.isArray(dup)) {
      ...
      if (typeof dup.$forgettable === "object") {
        for (const x2 of Object.keys(dup.$forgettable)) {
          if (!pred([...path, x2])) {
            continue;
          }
          if (!dup.$forgotten) {
          ...
          if (!dup.$forgotten[x2]) {
            const membValCanon = stringToBytes(canonicalJson(scrub(dup[x2])) + "\0");
            const membSalt = stringToBytes(dup.$forgettable[x2] + "\0");
            const h3 = kdf(64, membValCanon, membSalt, new Uint8Array([]));
            dup.$forgotten[x2] = encodeCrock(h3);
          }
          delete dup[x2];
          delete dup.$forgettable[x2];
        }
        if (Object.keys(dup.$forgettable).length === 0) {
          delete dup.$forgettable;
        }
      }
      for (const x2 of Object.keys(dup)) {
        if (x2.startsWith("$")) {
          continue;
        }
        dup[x2] = forgetAllImpl(dup[x2], [...path, x2], pred);
      }
    }
    return dup;
  }
  ...
  function validateForgettable(anyJson) {
    ...
    if (Array.isArray(anyJson)) {
      return anyJson.every((x2) => validateForgettable(x2));
    }
      ...
      for (const k3 of Object.keys(anyJson)) {
        ...
        if (k3 === "$forgettable") {
          ...
          for (const fk of Object.keys(fgo)) {
            ...
            if (((_a = anyJson.$forgettable) === null || _a === void 0 ? void 0 : _a[k3]) !== void 0) {
              return false;
            }
          }
        } else {
...
var useTranslationContext = () => q(Context);
var Page = ({ children }) => {
  return /* @__PURE__ */ h("div", {
    style: {
...
var ResizeHandleDiv = (_a) => {
  var _b = _a, { children } = _b, props = __objRest(_b, ["children"]);
  return /* @__PURE__ */ h("div", __spreadProps(__spreadValues({}, props), {
    style: {
      width: 10,
      backgroundColor: "#ddd",
      cursor: "ew-resize"
...
function findByGroupComponentName(allExamples, group, component, name) {
  const gl = allExamples.filter((e3) => e3.title === group);
  if (gl.length === 0) {
    return void 0;
  }
  const cl = gl[0].list.filter((l3) => l3.name === component);
  if (cl.length === 0) {
    return void 0;
  }
  const el = cl[0].examples.filter((c3) => c3.name === name);
  if (el.length === 0) {
    return void 0;
  }
  return el[0];
}
function getContentForExample(item, allExamples) {
  if (!item)
    return function SelectExampleMessage() {
      return /* @__PURE__ */ h("div", null, "select example from the list on the left");
    };
  ...
  if (!example) {
    return function ExampleNotFoundMessage() {
      return /* @__PURE__ */ h("div", null, "example not found");
    };
  }
...
function ExampleList({
  ...
  const [isOpen, setOpen] = p2(selected && selected.group === name);
  return /* @__PURE__ */ h("ol", {
    ...
    style: { display: isOpen ? void 0 : "none" }
  }, list.map((k3) => /* @__PURE__ */ h("li", {
    key: k3.name
  }, /* @__PURE__ */ h("dl", {
    style: { margin: 0 }
  }, /* @__PURE__ */ h("dt", null, k3.name), k3.examples.map((r3, i3) => {
    const e3 = encodeURIComponent;
    const eId = `${e3(r3.group)}-${e3(r3.component)}-${e3(r3.name)}`;
    const isSelected = selected && selected.component === r3.component && selected.group === r3.group && selected.name === r3.name;
    return /* @__PURE__ */ h("dd", {
      id: eId,
      key: r3.name,
      style: {
        backgroundColor: isSelected ? "green" : i3 % 2 ? "lightgray" : "lightblue",
        marginLeft: "1em",
        padding: 4,
        cursor: "pointer",
        borderRadius: 4,
...
function PreventLinkNavigation({
  ...
  return /* @__PURE__ */ h("div", {
    onClick: (e3) => {
      let t3 = e3.target;
      do {
        if (t3.localName === "a" && t3.getAttribute("href")) {
          alert(`should navigate to: ${t3.attributes.href.value}`);
...
function ErrorReport({
  ...
  h2(() => error2 ? resetError : void 0);
  if (error2) {
    return /* @__PURE__ */ h("div", null, /* @__PURE__ */ h("p", null, "Error was thrown trying to render"), selected && /* @__PURE__ */ h("ul", null, /* @__PURE__ */ h("li", null, /* @__PURE__ */ h("b", null, "group"), ": ", selected.group), /* @__PURE__ */ h("li", null, /* @__PURE__ */ h("b", null, "component"), ": ", selected.component), /* @__PURE__ */ h("li", null, /* @__PURE__ */ h("b", null, "example"), ": ", selected.name), /* @__PURE__ */ h("li", null, /* @__PURE__ */ h("b", null, "args"), ":", " ", /* @__PURE__ */ h("pre", null, JSON.stringify(selected.render.props, void 0, 2)))), /* @__PURE__ */ h("p", null, error2.message), /* @__PURE__ */ h("pre", null, error2.stack));
  }
  return /* @__PURE__ */ h(p, null, children);
}
function getSelectionFromLocationHash(hash3, allExamples) {
  if (!hash3)
    return void 0;
  const parts = hash3.substring(1).split("-");
  if (parts.length < 3)
    return void 0;
...
function parseExampleImport(group, componentName, im) {
  const examples = Object.entries(im).filter(([k3]) => k3 !== "default").map(([exampleName, exampleValue]) => {
    if (!exampleValue) {
      throw Error(
    ...
    if ("component" in v3 && typeof v3.component === "function" && "props" in v3) {
      return {
        group,
        component: componentName,
        name: exampleName,
...
function parseGroupImport(groups) {
  return Object.entries(groups).map(([groupName, value]) => {
    return {
      title: groupName,
      list: Object.entries(value).flatMap(
        ([key, value2]) => folder(groupName, value2)
      )
    };
  });
}
function folder(groupName, value) {
  let title = void 0;
  try {
    title = typeof value === "object" && typeof value.default === "object" && value.default !== void 0 && "title" in value.default && typeof value.default.title === "string" ? value.default.title : void 0;
  } catch (e3) {
    throw Error(
  ...
  if (title) {
    const c3 = parseExampleImport(groupName, title, value);
    return [c3];
  }
  return Object.entries(value).flatMap(
    ([subkey, value2]) => folder(groupName, value2)
  );
}
function Application({
  ...
  const [selected, updateSelected] = p2(
    initialSelection
  );
  const [sidebarWidth, setSidebarWidth] = p2(200);
  h2(() => {
    if (location.hash) {
      const hash3 = location.hash.substring(1);
      const found = document.getElementById(hash3);
      if (found) {
        setTimeout(() => {
  ...
  const GroupWrapper = getWrapperForGroup((selected == null ? void 0 : selected.group) || "default");
  const ExampleContent = getContentForExample(selected, examplesInGroups);
  return /* @__PURE__ */ h(Page, null, /* @__PURE__ */ h(SideBar, {
    width: sidebarWidth
  }, /* @__PURE__ */ h("div", null, "Language:", /* @__PURE__ */ h("select", {
    value: currentLang,
    onChange: (e3) => {
      const url2 = new URL(window.location.href);
      url2.searchParams.set("lang", e3.currentTarget.value);
      window.location.href = url2.href;
    }
  }, Object.keys(langs).map((l3) => /* @__PURE__ */ h("option", {
    key: l3
  }, l3)))), examplesInGroups.map((group) => /* @__PURE__ */ h(ExampleList, {
    key: group.title,
    name: group.title,
    list: group.list,
    selected,
    onSelectStory: (item, htmlId) => {
      var _a;
      (_a = document.getElementById(htmlId)) == null ? void 0 : _a.scrollIntoView({
        block: "center"
      });
      updateSelected(item);
    }
  })), /* @__PURE__ */ h("hr", null)), /* @__PURE__ */ h(ResizeHandle, {
    onUpdate: (x2) => {
      setSidebarWidth((s2) => s2 + x2);
    }
  }), /* @__PURE__ */ h(Content, null, /* @__PURE__ */ h(ErrorReport, {
    selected
  }, /* @__PURE__ */ h(PreventLinkNavigation, null, /* @__PURE__ */ h(GroupWrapper, null, /* @__PURE__ */ h(ExampleContent, null))))));
}
function renderStories(groups, options = {}) {
  var _a, _b, _c;
  const examples = parseGroupImport(groups);
  try {
    const cid = (_a = options.id) != null ? _a : "container";
    ...
    P(
      /* @__PURE__ */ h(Application, {
        examplesInGroups: examples,
        getWrapperForGroup: (_b = options.getWrapperForGroup) != null ? _b : () => p,
        langs: (_c = options.strings) != null ? _c : { en: {} }
      }),
      container
    );
  } catch (e3) {
    ...
    if (e3 instanceof Error) {
      document.body.innerText = `Fatal error: "${e3.message}".  Please report this bug at https://bugs.gnunet.org/.`;
    }
  }
}
function ResizeHandle({ onUpdate }) {
  const [start, setStart] = p2(void 0);
  return /* @__PURE__ */ h(ResizeHandleDiv, {
    onMouseDown: (e3) => {
      setStart(e3.pageX);
      console.log("active", e3.pageX);
      return false;
    },
    onMouseMove: (e3) => {
      if (start !== void 0) {
        onUpdate(e3.pageX - start);
      }
      return false;
    },
    onMouseUp: () => {
...
// src/pages/QrCodeSection.stories.tsx
var QrCodeSection_stories_default = {
